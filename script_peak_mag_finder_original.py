...
peak_mag_summ = Table(names = ('name', 'redshift', 'filter',
                               'pflux','e_pflux', 'papmag', 'e_papmag', 'pday','e_pday'),
                      dtype = ('S20',  'f8' ,'S20', 'f8',  'f8',  'f8',  'f8',  'f8', 'f8'))


finris  = ascii.read('/Users/r.saturn/PhD/WIP/Full_RISNeII_ZTF1/tables/RISNeII_radeczeztexp_30062021.csv')
...
PATH_SAVE = '/Users/r.saturn/PhD/WIP/Full_RISNeII_ZTF1/peak_mag/p3_0-2_10-25d/'
...
for candiname in finris['name']:
    ...
    if len(r_band.table)>0: 
        ...
        peak_mag_summ.add_row([ _tempinfo['name'][0],  _tempinfo['redshift'][0], 'r', rmf, remf,
    ...
    if len(g_band.table)>0:
        ...
        peak_mag_summ.add_row([ _tempinfo['name'][0],  _tempinfo['redshift'][0], 'g', gmf, gemf,
