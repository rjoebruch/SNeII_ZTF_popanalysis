...
class Fit_broken_PL( object ):
    ...
    def plot_fit(self, add_plot = False):
        ...
        _errors = [self.minuit_output.params[x].error for x in range(7)]
    ...
    def plot_current_parameters(self, add_plot = False):
        ...
        _params = [self.minuit.params[x].value for x in range(7)]
        _errors = [self.minuit.params[x].error for x in range(7)]
